...
Logo exports also use `#10130f` for dark avatar/favicon backgrounds, `#35452a`
for the avatar's framing lines, and `#17210f` lettering with `#4c771d` geometry
for the light-background wordmark. These are asset colors, not replacements
for the page background token.
...
intended background. Where the kit supplies additional transparent green,
dark, or white variants, dark/light avatars, or an outline-only monogram, choose
the variant by role and verify its filename in the kit inventory. Preserve its
